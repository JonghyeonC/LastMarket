  ...
  return (
    <div >
      ...
      <div className="navbar_down">
        ...
        <span><input className="nav_input" type="text" placeholder="검색해보세요" onChange={(e) => setInputValue(e.target.value.trim())} onKeyPress={(e) => { if (e.key === 'Enter') { navigate("/search/" + inputValue) } }} /></span>
        <span>
          <span>
