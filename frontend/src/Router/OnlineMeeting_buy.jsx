...
class OnlineMeeting_buy extends Component {
  render() {
      ...
      <Container>
        ...
        <Bottom>
          <BottomBox>
            ...
            <Icon primary onClick={() => {this.leaveSession() ;  this.props.navigate('/detail/' + (this.state.mySessionId)) }}>
              <CallEndIcon />
            </Icon>
          </BottomBox>
          {/* <ChatIconBox
...
export default WithRouter(OnlineMeeting_buy);