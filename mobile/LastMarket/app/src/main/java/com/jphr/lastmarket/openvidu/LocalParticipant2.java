...
public class LocalParticipant2 extends Participant2 {
    ...
    public LocalParticipant2(String participantName, Session2 session, Context context, SurfaceViewRenderer localVideoView) {
